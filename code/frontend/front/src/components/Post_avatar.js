...
//     setLoading(true);
//     await deleteDoc(doc(db, "posts", props.posts.id))
//       .then(() => {
//         setLoading(false);
//         onClose();
//         toast({
...
//       });
//   };
//   const [caption, setCaption] = useState(props?.posts.caption);
...
//   useEffect(() => {
//     setLiked(
//       likes?.findIndex((like) => like?.id === auth?.currentUser?.uid) !==
//         -1
//     );
//   }, [likes]);
...
//     await addDoc(
//       collection(db, "posts", props?.posts?.id, "comments"),
//       {
//         comment: comment,
